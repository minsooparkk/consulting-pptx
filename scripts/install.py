...
def main():
    ...
    if not (source / "SKILL.md").is_file() or source.name != NAME:
        raise ValueError("Keep the complete consulting-pptx directory intact before running this installer")
    ...
    for item in plan:
        ...
        try:
            ...
            raise
    print(json.dumps({"installed": True, "plan": plan, "note": "Open Codex or Claude Code and confirm that consulting-pptx appears in its skills list."}, ensure_ascii=False, indent=2))
    return 0
